...
# global parameters 
imageDir='/scratch2/NCEPDEV/stmp1/Samira.Ardani/images/class-4/fronts'
dbfile='/scratch2/NCEPDEV/ovp/Samira.Ardani/VPPPG/Global_RTOFS/EMC_ocean-verification/fronts/fix/global_fronts.db'
modelDir=[]
...
def load_regions():
    ...
    region['kuroshio']['lims']=[115, 175, 25, 45]
...
def plot_stats(region):
    ...
    # get all dates
    #dbfile='/scratch2/NCEPDEV/ocean/Deanna.Spindler/save/VPPPG/Global_RTOFS/EMC_ocean-verification/fronts/fix/global_fronts.db'
    conn = sqlite3.connect(dbfile,detect_types=sqlite3.PARSE_DECLTYPES,timeout=30.0)
...
if __name__ == '__main__':
    ...
    modelDir='/scratch2/NCEPDEV/ovp/Samira.Ardani/Global/archive/'+theDate.strftime('%Y%m%d')
    ...
    if MOVE_TO_POLAR:
        ...
        remoteDir='/home/www/polar/global/fronts/archive/images/'
        subprocess.call('scp -r '+imageDir+'/'+theDate+'/ tspindler@140.90.100.206:'+remoteDir+'/.',shell=True)
        subprocess.call('scp -r '+imageDir+'/stats/ tspindler@140.90.100.206:'+remoteDir+'/.',shell=True)
        subprocess.call('scp '+imageDir+'/blockDates.js tspindler@140.90.100.206:'+remoteDir+'/js/.',shell=True)
        subprocess.call('rm -rf '+imageDir+'/'+theDate,shell=True)
        subprocess.call('rm -rf '+imageDir+'/stats',shell=True)
