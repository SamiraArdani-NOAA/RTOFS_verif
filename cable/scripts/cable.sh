...
PROJ='marine-cpu'
#PROJ='ovp'
LOGPATH=/scratch2/NCEPDEV/stmp1/Samira.Ardani/logs/class-4/cable
JOB="cable"

mkdir -p $LOGPATH
rm -f $LOGPATH/*.log

export SRCDIR='/scratch2/NCEPDEV/ovp/Samira.Ardani/VPPPG/Global_RTOFS/EMC_ocean-verification/cable'
